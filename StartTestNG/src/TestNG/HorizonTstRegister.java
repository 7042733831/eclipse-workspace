...
public class HorizonTstRegister 
{

	@Parameters({"EmailAddress","Password","FirstName","LastName","address1","City","ZipCode","Phone"})	
@Test(priority=0)
  public void TstRegisteration(String EmailAddress,String Password,String FirstName,String LastName,String address1, String City, String ZipCode, String Phone  )
  {
