...
public class HorizonDevRegister 
{

	@Parameters({"EmailAddress","Password","FirstName","LastName","address1","City","ZipCode","Phone"})	
@Test(priority=0)
  public void DevRegisteration(String EmailAddress,String Password,String FirstName,String LastName,String address1, String City, String ZipCode, String Phone  )
  {

		System.setProperty("webdriver.chrome.driver","D:\\Drivers\\chromedriver.exe");
		
		WebDriver driver = new ChromeDriver();
		driver.get("https://www-dev.horizonhobby.com");
